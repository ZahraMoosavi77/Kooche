                ...
                ({ title, src, srcActive, link, alt, url }, index) =>
                  primaryPath === url ? (
                    ...
                    <div
                      ...
                      className="flex items-center justify-start gap-2 py-2 text-primary cursor-pointer"
                    >
                      <Image
                        src={`${srcActive}`}
                        width={24}
                    ...
                    <div
                      onClick={routChanger(link)}
                      key={index}
                      className="flex items-center justify-start gap-2 py-2 text-gray-900 cursor-pointer"
                    >
                      <Image
                        src={src}
                        width={24}
